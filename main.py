...
def load_config():
    ...
    class Config:
        ...
        claude_cli_use_stdin: bool = True
        openai_model: str = "gpt-4.1-mini"
        openai_timeout_seconds: int = 600
        openai_cli_command: str = "openai"
        openai_cli_args: str = "responses create -m {model} -i -"
        openai_cli_use_stdin: bool = True
        openai_cli_output_json_path: str = "output[0].content[0].text"
        review_model: str = "claude-3-5-haiku-latest"

    ...
    def temp_config_files(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            config_data = {
                ...
                "claude_cli_use_stdin": True,
                "openai_model": "gpt-4.1-mini",
                "openai_timeout_seconds": 600,
                "openai_cli_command": "openai",
                "openai_cli_args": "responses create -m {model} -i -",
                "openai_cli_use_stdin": True,
                "openai_cli_output_json_path": "output[0].content[0].text",
                "review_model": "claude-3-5-haiku-latest",
